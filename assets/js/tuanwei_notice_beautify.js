(function () {
  ...
  css.textContent = `
    ...
    .footer, .door, .link, .Foot, .flexslider, .Tops, .naver, .sidenav,
    .toolbar, .paging { display: none !important; }
    ...
    .main-box, .listContent { width: 100% !important; padding: 0 !important; margin: 0 !important; max-width: 640px !important; float: none !important; margin: 0 auto !important; }
    ...
    .p_pages .p_t { color: #999 !important; font-size: 13px !important; margin-left: 4px !important; cursor: default !important; }
    .p_pages input.p_goto_input {
      width: 48px !important; height: 32px !important; padding: 0 4px !important;
      border: 1px solid #e0e0e0 !important; border-radius: 6px !important; text-align: center !important;
      font-size: 13px !important; outline: none !important; box-sizing: border-box !important;
    }
    .p_pages a.p_goto {
      display: inline-flex !important; align-items: center !important; justify-content: center !important;
      height: 32px !important; padding: 0 10px !important; background: #fff !important; color: #333 !important;
    ...
    .pb_sys_common .p_t { color: #999 !important; font-size: 13px !important; cursor: default !important; }
